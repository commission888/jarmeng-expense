...
const HELP_TEXT = [
  ...
  'พิมพ์ชื่อของ + จำนวนเงิน เดี๋ยวจาเหมงบันทึกให้เลย',
  '',
  '📤 รายจ่าย',
  'พิมพ์ชื่อของแล้วตามด้วยจำนวน',
  'เช่น  กาแฟ 50   /   ค่าน้ำ 300 บาท',
  '',
  '📥 รายรับ',
  'ใส่เครื่องหมาย + ไว้ข้างหน้า หรือใช้คำว่า เงินเดือน / โบนัส',
  'เช่น  +30000 ฟรีแลนซ์   /   เงินเดือน 45000',
  '',
  '📊 ดูยอด',
  'พิมพ์  สรุป  เพื่อดูยอดรับ-จ่ายของเดือนนี้',
  '',
  '🗑️ พิมพ์ผิด / อยากลบ',
  'พิมพ์  ลบ  เพื่อลบรายการล่าสุดที่เพิ่งบันทึก',
  'แล้วพิมพ์รายการที่ถูกต้องเข้ามาใหม่ได้เลย',
  '',
  'พิมพ์  วิธีใช้งาน  เมื่อไหร่ก็ได้ เพื่อดูข้อความนี้อีกครั้ง',
].join('\n');

const HELP_COMMANDS = ['ช่วยเหลือ', 'help', 'วิธีใช้', 'วิธีใช้งาน', '?'];
